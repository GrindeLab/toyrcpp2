...
The two functions should give you the exact same R, since they implement the same task; one is just written using R code (`timesTwoR`) and the other uses C++ code (`timesTwoCpp`) which is called within R thanks to the `Rcpp` package.
